---
title: 'STA304 Final Project: To Evaluate Effects of Bike Features and Parking Locations
  on Bike Thefts in Toronto'
author: "Ziyi Qu"
date: "12/21/2020"
output:
...
```
  ...
  | Table 1: Columns of Raw Data (26 in total)  | 
----------|-----------|----- |
"_id" | "Index_" | "event_unique_id" 
"Primary_Offence" | "Primary_Offence""Occurrence_Date" | "Occurrence_Year" 
"Occurrence_Month"  | "Occurrence_Day" | "Occurrence_Time" 
"Division" | "City" | "Location_Type"  
"Premise_Type" | "Bike_Make" | "Bike_Model" 
"Bike_Type" | "Bike_Speed" | "Bike_Colour" 
"Cost_of_Bike" | "Status" | "Hood_ID" 
...
The target population of my analysis is all the bikes that are actually theft in the Greater Toronto Area, the frame population is the potential police official list including all stolen bikes that are reported in the Greater Toronto Area, and the sample population is the observations from actual dataset uploaded by the Toronto Police Services on the Toronto Open Data Portal, which I use to conduct the analysis.
...
Table 2: Baseline Characteristics of Reduced Data |  | 
----------|---------|----- | 
Variable | Mean | SD
----------|---------|----- | 
if_stolen | 0.52 | 0.50 
if_dark_colour | 0.55 | 0.50
cost_of_bike | 977.74 | 1733.57 
if_near_city_center | 0.89 | 0.31
location_type (%) | | 
educational | 173 | 4.0 
residential | 2587 | 60.1
social | 1545 | 35.9
if_popular_type | 0.79 | 0.41
...
+ ${\beta}_6$${location\_typesocial}$ + ${\epsilon}$

where ${\beta}_0$ is the intercept parameter, ${\beta}_1$ ~ ${\beta}_{6}$ are the slope parameters, and ${\epsilon}$ is the error term.
...
Table 3: Summary of Logistic Model on Reduced Data |  |
----------|-----------|-----------| 
Predictor | Coefficient | P-value
----------|-----------|-----------|
Intercept | -0.663 | 0.000434
cost_of_bike | 0.000173 | 0.000000612
as.factor(if_dark_colour)1 | 0.0109 | 0.860
as.factor(if_popular_type)1 | 0.142 | 0.0628
as.factor(if_near_city_center)1 | 0.273 | 0.00696
location_typeresidential | 0.292 | 0.0668
location_typesocial | 0.0771 | 0.637
...
Table 4: Summary of Model Diagnostics Results |  | |
----------|-----------|----- | ----- | 
Model | AIC | BIC | AUC
--------- | ------- | ------- |------- | 
...
```{r, echo=FALSE}
plot(ROC, auc.polygon=TRUE, print.auc = TRUE,asp = NA, main = "Table 5: AUC of original model")
```

```{r, echo=FALSE}
plot(ROC_alt, auc.polygon=TRUE, print.auc = TRUE,asp = NA, main ="Table 6: AUC of alternative model")
```
...
----------|-----------|-----------| 
95 percent confidence interval | mean of x | mean of y
----------------------------------------|-----------|-----------| 
(-419.5521, -255.0212) | 416.4967 | 753.7834
...
Table 8: Summary of Logistic Model on New Matched Data |  |
----------|-----------|-----------| 
predictor | coefficient | p-value
----------|-----------|----------- | 
Intercept | -0.682 | 0.0344
cost_of_bike | 0.000314 | 0.0116
if_dark_colour | 0.0167 | 0.919
if_popular_type | 0.139 | 0.549
if_near_city_center | 0.189 | 0.254
location_typeresidential | 0.257 | 0.177
location_typesocial | -0.223 | 0.447
...
Andrew, G. and Yu-Sung, S. (2020). arm: Data Analysis Using Regression and Multilevel/Hierarchical Models. R package version 1.11-2.
...
Retrieved from https://wtop.com/overhead-door/2018/06/5-tips-on-keeping-your-garage-safe-from-theft/#:~:text=Garages%20are%20a%20vulnerable%20place,your%20garage%20safe%20from%2
